...
CREATE TABLE `pedidosprodutos` (
  ...
  KEY `pedidosprodutos_FK` (`CodProduto`),
  KEY `pedidosprodutos_FK_1` (`Pedido`),
  CONSTRAINT `pedidosprodutos_FK` FOREIGN KEY (`CodProduto`) REFERENCES `produtos` (`CodProduto`) ON DELETE RESTRICT,
  CONSTRAINT `pedidosprodutos_FK_1` FOREIGN KEY (`Pedido`) REFERENCES `pedidosdadosgerais` (`Pedido`) ON DELETE RESTRICT
